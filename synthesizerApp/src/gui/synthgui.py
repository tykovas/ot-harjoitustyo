...
class SynthGui: 
    def __init__(self):
        ...
        self.duration_text = pgui.elements.UITextBox("Note Length",relative_rect=(pg.Rect((30, 200), (100, 30))),manager=self.manager)
        self.duration_text = pgui.elements.UITextBox("Release",relative_rect=(pg.Rect((30, 280), (100, 30))),manager=self.manager)
        ...
        self.release_slider = pgui.elements.UIHorizontalSlider(relative_rect=(pg.Rect((30,310),(200,40))),start_value=0.5,value_range=(0,1),manager=self.manager)